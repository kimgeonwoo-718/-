 ...
 * ## 왜 1만 5천인가
 *
 * **천장은 원가 아래에 있어야 한다.** 2만으로 뒀을 때 매일 꽉 쓰는 사람의 원가가
 * 구독료를 넘었다 — 200자씩 100번이면 월 3,109원, 100자씩 200번이면 월 3,473원인데
 * 받는 돈은 2,990원이다. 그런 사람이 실제로 나타날 확률은 낮지만, 천장이 원가 위에
 * 있으면 나타났을 때 막을 방법이 없다.
 *
 * 1만 5천이면 매일 꽉 써도 월 2,300원 남짓이라 690원쯤 남는다. 그러면서도 카톡 한
 * 줄(30자)은 하루 500번, 긴 문자(500자)는 30번이다 — 실제로 닿는 사람이 거의 없다.
 *
